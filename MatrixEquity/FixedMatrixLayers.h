...
{
public:
	FixedMatrixLayers(vector<string> inpMatrixCards, ProbToWinWithCard* PTWWC, CardsCombos* CardCombos, 
		EqSummTables* eqTables, setsOfHittedCells* itsSetsOfHittedCells);
...
private:
	...
	EqSummTables* itsEqTables;
	setsOfHittedCells* itsSetsOfHittedCells;
